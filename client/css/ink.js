Meteor.startup(function() {
	...
	$('body').on('mousedown', '.btn, .floating-action-button, .nav li a', function(evt){
		var elem = $(this);
		var multiple = false;
		...
		if(!multiple) {
			if(elem.find(".ink").length == 0) elem.prepend("<span class='ink'></span>");
		}
		else elem.prepend("<span class='ink'></span>");
